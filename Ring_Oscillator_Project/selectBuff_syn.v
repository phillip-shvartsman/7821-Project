...
//altiobuf_in DEVICE_FAMILY="Cyclone IV E" ENABLE_BUS_HOLD="FALSE" NUMBER_OF_CHANNELS=1 USE_DIFFERENTIAL_MODE="FALSE" USE_DYNAMIC_TERMINATION_CONTROL="FALSE" datain dataout
...
module selectBuff (
	...
	selectBuff_iobuf_in	selectBuff_iobuf_in_component (
				.datain (datain),
				.dataout (sub_wire0));
